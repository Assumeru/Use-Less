...
public class UseLess {
	...
	private static List<Token> getTokenParsers() {
		...
		tokenParsers.add(new ShortAllocationToken());
		tokenParsers.add(new IntegerAllocationToken());
		tokenParsers.add(new LongAllocationToken());
		tokenParsers.add(new AllocationToken());
		tokenParsers.add(new DeallocationToken());
		...
		tokenParsers.add(new VariableNameToken());
